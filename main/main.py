...
left_side = set([(pos_x_rect, y) for y in range(pos_y_rect, pos_y_rect + rect_height + 1)])
right_side = set([(pos_x_rect + rect_width, y) for y in range(pos_y_rect, pos_y_rect + rect_height + 1)])
# game object variables #
print(left_side)
print(right_side)
# session variables #
